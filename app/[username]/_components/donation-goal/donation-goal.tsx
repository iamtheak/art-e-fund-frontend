...
export default function CreatorDonationGoal({creatorId, isSameUser}: CreatorDonationGoalProps) {
    ...
    if (!donationGoal && isSameUser) {
        ...
        return (
            <Link href="/view-donations">
                <div
                    className={"w-full h-[80px] border-none shadow-md bg-gradient-to-br from-mint to-mint/80 rounded-xl overflow-hidden flex items-center justify-center w-full h-full"}>
                    <p> Create your donation goal </p>
                    <div
    ...
    return (
        <Card
            className="w-full border-none shadow-md bg-gradient-to-br from-mint to-mint/80 rounded-xl overflow-hidden">
